define({
    ...
    BRACKETS_GIT_ERROR:                    "Quadre Git 遇到了一个错误\u2026",
    ...
    ERROR_CONNECT_NODEJS:                  "尝试连接到 NodeJS 失败。如果您刚更新这个插件，那么请关闭所有 Quadre 程序窗口，然后尝试重新启动。",
    ...
    Q_RESTART_BRACKETS:                    "希望现在重启 Quadre 并应用更改吗？",
