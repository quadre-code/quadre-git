define({
    ...
    BRACKETS_GIT_ERROR:                    "Quadre Git encontrou um erro\u2026",
    ...
    // CHECK_GIT_SETTINGS:                 "Failed to launch Git executable - fix Git settings and restart Quadre",
    ...
    // DEBUG_MODE_SETTING:                 "DEBUG mode &mdash; Leave this OFF unless you need to find a problem with the extension. All Git communication will be forwarded to Quadre console!",
    DEBUG_MODE_SETTING:                    "Modo de depuração &mdash; Deixe isto DESLIGADO a não ser que precise encontrar um problema na extensão. Toda a comunicação do Git será redirecionada ao console do Quadre!",
    ...
    // ERROR_CONNECT_NODEJS:               "Failed to connect to NodeJS. If you've just updated the extension then close all instances of Quadre and try starting again.",
    ERROR_CONNECT_NODEJS:                  "Falha ao conectar com o NodeJS. Se você acabou de atualizar a extensão, feche todas as instâncias do Quadre e tente novamente.",
    ...
    // Q_RESTART_BRACKETS:                 "Do you wish to restart Quadre to apply new settings?",
    Q_RESTART_BRACKETS:                    "Deseja reiniciar o Quadre para aplicar as novas configurações?",
