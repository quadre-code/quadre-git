define({
    ...
    ERROR_CONNECT_NODEJS:               "Failed to connect to NodeJS. If you've just updated the extension then close all instances of Quadre and try starting again. If restart doesn't help try removing other extensions that you've installed as one of them is probably causing this problem.",
